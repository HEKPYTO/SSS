...
by SHA-256 before compilation. See
[`docs/research/sss-requirements.md`](docs/research/sss-requirements.md) for the
behavioral contract derived from the paper and ancillary implementation.
